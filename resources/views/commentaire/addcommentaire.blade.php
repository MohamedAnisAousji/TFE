<x-Client-layout>
<div class="flex justify-center items-center min-h-screen bg-gray-100"> <!-- Ajout d'un arrière-plan pour tout l'écran -->
    <div class="w-full max-w-md p-6 bg-white rounded-lg shadow-lg"> <!-- Cadre autour du formulaire -->
