        ...
        <div class="mt-5 w-full max-w-md">
            <form method="POST" action="{{ route('editclient.save') }}" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                ...
                <div class="mb-4">
                    ...
                    <input value="{{ $client->Nom_Parent }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" id="Nom_Parent" name="Nom_Parent" required>
                </div>
                ...
                <div class="mb-4">
                    ...
                    <input value="{{ $client->Prenom_Parent }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" type="text" id="Prenom_parent" name="Prenom_Parent" required>
                </div>
